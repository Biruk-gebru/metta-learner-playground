...
const Layout = ({ children, headings: headingsProp }: { children: React.ReactNode, headings?: any }) => {
  ...
  return (
    <div className={"min-h-screen flex flex-col bg-metta-darkBg"}>
      {/* Top nav bar/header */}
      <header className="fixed top-0 left-0 z-40 w-full flex items-center justify-between px-8 py-4 border-b bg-metta-darkPanel border-metta-darkPanel" style={{ minHeight: '64px' }}>
        ...
        {/* Removed Reset AtomSpace button and search bar */}
      </header>
      <div className="flex flex-1 pt-20 bg-metta-darkBg">
        ...
        <aside className="w-64 min-w-56 max-w-64 h-full border-l bg-metta-darkPanel p-4 flex-shrink-0 overflow-y-auto">
